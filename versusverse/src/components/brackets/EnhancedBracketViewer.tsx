// src/pages/Brackets/components/brackets/EnhancedBracketViewer.tsx
...
export function EnhancedBracketViewer({ bracket, onUpdateBracket }: EnhancedBracketViewerProps) {
...
export default EnhancedBracketViewer;